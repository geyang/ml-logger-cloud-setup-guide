...
aws s3 cp s3://ge-bair/doodad/mount/b57f05bfff0397f91f5a7c3b0b71766c.tar /tmp/b57f05bfff0397f91f5a7c3b0b71766c.tar
...
aws s3 cp s3://ge-bair/doodad/mount/6eded1ede08c6e323527417195f48431.tar /tmp/6eded1ede08c6e323527417195f48431.tar
...
while /bin/true; do
    aws s3 sync --exclude '*' --include '*.png' --include '*.log' /tmp/example/outputs s3://ge-bair/doodad/logs/infogan-rope/infogan-rope-2018-03-28-10-18-16-000/
    aws s3 cp /home/ubuntu/user_data.log s3://ge-bair/doodad/logs/infogan-rope/infogan-rope-2018-03-28-10-18-16-000/stdout.log
    sleep 15
...
while /bin/true; do
    ...
    then
        ...
        aws s3 cp --recursive /tmp/example/outputs s3://ge-bair/doodad/logs/infogan-rope/infogan-rope-2018-03-28-10-18-16-000/
        break
    else
...
nvidia-docker run  -v /tmp/b57f05bfff0397f91f5a7c3b0b71766c/doodad:/root/code/doodad \
    ...
    thanard/matplotlib:latest /bin/bash -c 'echo "Running in docker (gpu)";export PYTHONPATH=$PYTHONPATH:/root/code/doodad:/Users/ge/machine_learning/berkeley-playground/infoGAN-pytorch-rope;DOODAD_ARGS_DATA=gAN9cQAoWAgAAABkYXRhX2RpcnEBWC4AAAAvVXNlcnMvZ2UvbWFjaGluZV9sZWFybmluZy9kYXRhc2V0cy9yb3BlL3RyYWlucQJYCgAAAG91dHB1dF9kaXJxA1gQAAAAL2V4YW1wbGUvb3V0cHV0c3EEWAQAAABzZWVkcQVLAHUu DOODAD_USE_CLOUDPICKLE=0 DOODAD_CLOUDPICKLE_VERSION=n/a python /mounts/target/main.py'
aws s3 cp --recursive /tmp/example/outputs s3://ge-bair/doodad/logs/infogan-rope/infogan-rope-2018-03-28-10-18-16-000/
aws s3 cp /home/ubuntu/user_data.log s3://ge-bair/doodad/logs/infogan-rope/infogan-rope-2018-03-28-10-18-16-000/stdout.log
sleep 20
